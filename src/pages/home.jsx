...
const home = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get('http://localhost:3000/top/playlist?cat=ACG')
      .then((res) => {
    ...
    // 新歌上架的接口关了，先用一般的接口
    axios
      .get('http://localhost:3000/top/playlist?order=日语')
      .then((res) => {
    ...
    // ### 日语新歌榜
    axios
      .get('http://localhost:3000/top/song?type=8')
      .then((res) => {
        /* console.log(res); */
    ...
    // ### 新歌榜
    axios
      .get('http://localhost:3000/top/song?type=0')
      .then((res) => {
